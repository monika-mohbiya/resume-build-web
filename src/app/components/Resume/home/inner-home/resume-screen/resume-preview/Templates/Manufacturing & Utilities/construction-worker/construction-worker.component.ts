...
@Component({
  selector: 'app-construction-worker',
  imports: [CommonModule],
  templateUrl: './construction-worker.component.html',
  styleUrl: './construction-worker.component.scss'
})
export class ConstructionWorkerComponent {
