...
@Component({
  selector: 'app-physician-assistant',
  imports: [CommonModule],
  templateUrl: './physician-assistant.component.html',
  styleUrl: './physician-assistant.component.scss'
})
export class PhysicianAssistantComponent {
