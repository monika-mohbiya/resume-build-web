...
@Component({
  selector: 'app-clinical-nurse-specialist',
  imports: [CommonModule],
  templateUrl: './clinical-nurse-specialist.component.html',
  styleUrl: './clinical-nurse-specialist.component.scss'
})
export class ClinicalNurseSpecialistComponent {
