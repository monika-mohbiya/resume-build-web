...
@Component({
  selector: 'app-respiratory-therapist',
  imports: [CommonModule],
  templateUrl: './respiratory-therapist.component.html',
  styleUrl: './respiratory-therapist.component.scss'
})
export class RespiratoryTherapistComponent {
