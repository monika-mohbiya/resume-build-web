...
@Component({
  selector: 'app-quality-assurance-specialist',
  imports: [CommonModule],
  templateUrl: './quality-assurance-specialist.component.html',
  styleUrl: './quality-assurance-specialist.component.scss'
})
export class QualityAssuranceSpecialistComponent {
